...
features_train = pickle.load(open('features_train_doc2vec.pkl', 'rb'))
labels_train = pickle.load(open('labels_train_doc2vec.pkl', 'rb'))
...
# pickle.dump(features_train, open('features_train_doc2vec.pkl', 'wb'))
# pickle.dump(labels_train, open('labels_train_doc2vec.pkl', 'wb'))
# pickle.dump(features_test, open('features_test_doc2vec.pkl', 'wb'))
...
model = pickle.load(open('model_doc2vec_RF.pkl', 'rb'))
...
df = pd.DataFrame(tmp)
df.to_csv('labels_doc2vec_RF.csv', ',', columns=['test_id', 'is_duplicate'], index=False)
...
with open('CPU_time_doc2vec_RF.txt', 'w') as file:
    file.write(text)